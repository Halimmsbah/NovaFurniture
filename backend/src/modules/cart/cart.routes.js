...
cartRouter
.route('/')
.post(protectedRoutes,allowedTo('user','admin'),validation(addCartVal),addToCart)//
 ...
 */
cartRouter
.post('/applyCoupon',protectedRoutes,allowedTo('user','admin'),applyCoupon)
 ...
 *         description: Unauthorized
 */
cartRouter.delete('/clear', protectedRoutes, allowedTo('user','admin'), clearUserCart)

cartRouter
.route('/:id')
.delete(protectedRoutes, allowedTo('user','admin'), validation(paramsIdVal), removeItemFromCart)
.put(protectedRoutes, allowedTo('user','admin'), validation(updateQTYVal), updateQTY)

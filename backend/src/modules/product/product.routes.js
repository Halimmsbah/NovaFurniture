...
import { addProduct, deleteProduct, getAllProduct, getSingleProduct, updateProduct, reorderProducts } from "./product.controller.js";
...
productRouter.post('/reorder', protectedRoutes, IsAdmin, express.json(), reorderProducts)

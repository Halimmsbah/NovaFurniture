...
orderRouter 
.route('/:id') 
.post(protectedRoutes,allowedTo('user','admin'),validation(addOrderVal),createCashOrder)
 ...
 */
orderRouter 
.post('/checkOut/:id',protectedRoutes,allowedTo('user','admin'),createCheckOutSession)
...
orderRouter.patch('/admin/:orderId/status', protectedRoutes, allowedTo('admin'), updateOrderStatus)
orderRouter.patch('/admin/:orderId/notes', protectedRoutes, allowedTo('admin'), updateOrderNotes)
